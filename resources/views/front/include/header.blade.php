        ...
        <div class="header__topbar--inner d-flex align-items-center justify-content-between">
            <div class="header__shipping">
                <ul class="header__shipping--wrapper d-flex">
                    <li class="header__shipping--text text-white">Welcome to Spotlight Attires</li>
                    <li class="header__shipping--text text-white d-sm-2-none">
                        <img class="header__shipping--text__icon" src="{{asset('/')}}public/front/assets/img/icon/bus.png" alt="bus-icon"> Track Your Order
                    </li>
                    <li class="header__shipping--text text-white d-sm-2-none">
                        <img class="header__shipping--text__icon" src="{{asset('/')}}public/front/assets/img/icon/email.png" alt="email-icon">
                        <a class="header__shipping--text__link" href="mailto:{{ $email }}">{{ $email }}</a>
                    </li>
                </ul>
            </div>
            <div class="header__social">
                <ul class="header__social--inner d-flex align-items-center">
                    ...
                    <li class="header__social--list">
                        <a class="header__social--list__icon" target="_blank" href="{{ $all_ask_list_all->ans }}">
