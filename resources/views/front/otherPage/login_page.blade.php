...
?>
                                          <div class="checkout__input--list">
                                                <label>
                                                    <select  class="checkout__input--field border-radius-5 mt-3" placeholder="Division"
name="division"    required id="division" >
<option value="">-- Select Division --</option>
@foreach($district_list_all as $all_district_list_all)
<option value="{{$all_district_list_all->Division}}">{{$all_district_list_all->Division}}</option>
@endforeach
</select>
                                                </label>
                                            </div>
