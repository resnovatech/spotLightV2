                    ...
                    <div class="col mb-30">
                        <div class="blog__items">
                            <div class="blog__thumbnail">
                                <a class="blog__thumbnail--link" href="{{ route('blog_view',$all_blog_list->title) }}"><img class="blog__thumbnail--img" src="http://localhost/2023/moin_new_feb_14/{{ $all_blog_list->image }}" alt="blog-img"></a>
                            </div>
